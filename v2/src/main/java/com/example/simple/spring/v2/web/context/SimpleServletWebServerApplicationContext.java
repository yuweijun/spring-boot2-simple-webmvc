...
/**
 * A {@link SimpleWebApplicationContext} that can be used to bootstrap itself from a contained
 ...
 */
public class SimpleServletWebServerApplicationContext extends SimpleGenericWebApplicationContext
	...
	/**
	 * Create a new {@link SimpleServletWebServerApplicationContext}.
	 */
	public SimpleServletWebServerApplicationContext() {
	}

	/**
	 * Create a new {@link SimpleServletWebServerApplicationContext} with the given
	 ...
	 * setup of this {@link SimpleWebApplicationContext}.
		...
		try {
			...
			if (logger.isDebugEnabled()) {
				logger.debug("Published root WebApplicationContext as ServletContext attribute with name ["
						+ SimpleWebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE + "]");
			}
